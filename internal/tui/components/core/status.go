...
import (
	...
	"github.com/omnitrix-sh/cli/internal/lsp"
	"github.com/omnitrix-sh/cli/internal/lsp/protocol"
...
func getHelpWidget() string {
	...
	helpText := fmt.Sprintf("%s Help", styles.InfoIcon)
...
func (m statusCmp) model() string {
	...
	// Enhanced model display with bot icon
	modelText := fmt.Sprintf("%s %s", styles.BotIcon, model.Name)
