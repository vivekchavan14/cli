...
import (
	...
	"github.com/omnitrix-sh/cli/internal/diff"
...
func renderMessage(msg string, isUser bool, isFocused bool, width int, info ...string) string {
	...
	// Add subtle visual enhancement for focused messages
	if isFocused {
		style = style.BorderForeground(t.Accent()).Bold(true)
	}
...
func toolName(name string) string {
	...
	case agent.AgentToolName:
		return fmt.Sprintf("%s Task", styles.BotIcon)
	case tools.BashToolName:
		return fmt.Sprintf("%s Bash", styles.TerminalIcon)
	case tools.EditToolName:
		return fmt.Sprintf("%s Edit", styles.EditIcon)
	case tools.FetchToolName:
		return fmt.Sprintf("%s Fetch", styles.GlobeIcon)
	case tools.GlobToolName:
		return fmt.Sprintf("%s Glob", styles.SearchIcon)
	case tools.GrepToolName:
		return fmt.Sprintf("%s Grep", styles.SearchIcon)
	case tools.LSToolName:
		return fmt.Sprintf("%s List", styles.FolderIcon)
	case tools.SourcegraphToolName:
		return fmt.Sprintf("%s Sourcegraph", styles.CodeIcon)
	case tools.ViewToolName:
		return fmt.Sprintf("%s View", styles.DocumentIcon)
	case tools.WriteToolName:
		return fmt.Sprintf("%s Write", styles.EditIcon)
	case tools.PatchToolName:
		return fmt.Sprintf("%s Patch", styles.EditIcon)
	}
	return fmt.Sprintf("%s %s", styles.Dot, name)
}
