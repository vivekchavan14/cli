...
import (
	...
	"github.com/omnitrix-sh/cli/internal/tui/components/chat"
	"github.com/omnitrix-sh/cli/internal/tui/components/core"
	"github.com/omnitrix-sh/cli/internal/tui/components/dialog"
	"github.com/omnitrix-sh/cli/internal/tui/layout"
	"github.com/omnitrix-sh/cli/internal/tui/page"
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the Omnitrix.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a Omnitrix.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a omnitrix.md, improve it.
