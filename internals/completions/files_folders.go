...
func (cg *FilesAndFoldersContextGroup) GetEntry() CompletionItem {
...
func (cg *FilesAndFoldersContextGroup) GetChildEntries(query string) ([]CompletionItem, error) {
...
func NewFileAndFolderContextGroup() *FilesAndFoldersContextGroup {
